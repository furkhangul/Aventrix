<p align="right"><a href="./README.md">Türkçe</a> · English</p>
...
Every screen below is a real capture of the running app, logged in and populated with real activity — not mockups, not empty states.
...
### Dashboard — light & dark, with real traffic

<table>
<tr>
<td width="50%"><img src="docs/screenshots/04-dashboard.png" alt="Dashboard, light theme, populated with real visits"><br><sub>Light theme</sub></td>
<td width="50%"><img src="docs/screenshots/05-dashboard-dark.png" alt="Dashboard, dark theme, populated with real visits"><br><sub>Dark theme</sub></td>
</tr>
</table>

Total links, visits, unique visitors, today's visits, active projects, and a uniqueness ratio, a visit trend chart, and top countries/devices/browsers — all real numbers from links actually clicked during this walkthrough.

### Projects & links, with real click data

<table>
<tr>
<td width="50%"><img src="docs/screenshots/06-projects-list.png" alt="Projects list"><br><sub>Projects</sub></td>
<td width="50%"><img src="docs/screenshots/07-project-detail.png" alt="Project detail page with real stats"><br><sub>Project detail — real visit/unique counts</sub></td>
</tr>
<tr>
<td colspan="2"><img src="docs/screenshots/08-links-list.png" alt="Links list with real click counts"><br><sub>Links — each row shows real visits and unique visitors from simulated clicks across six countries</sub></td>
</tr>
</table>

### Analytics

<p align="center"><img src="docs/screenshots/09-analytics.png" alt="Analytics page with populated charts and breakdowns" width="860"></p>

### Security Center — a real scan, start to finish

<p align="center"><img src="docs/screenshots/10-security-scan.png" alt="Security Center — completed scan of example.com with findings, DNS, and WHOIS" width="860"></p>

A live scan against `example.com`: DNS records, IP/ASN, missing security headers each flagged by severity, and a computed 0–100 score — not a placeholder screen.

### URL Solutions — every tool, run with real input

<table>
<tr>
<td width="50%"><img src="docs/screenshots/11-urltools-encoder.png" alt="URL encoder/decoder with a real result"><br><sub>Encode / decode</sub></td>
<td width="50%"><img src="docs/screenshots/12-urltools-utm.png" alt="UTM builder with a real result"><br><sub>UTM builder</sub></td>
</tr>
<tr>
<td width="50%"><img src="docs/screenshots/13-urltools-analyzer.png" alt="URL analyzer with a real result"><br><sub>URL analyzer — live HTTP request, title, content type</sub></td>
<td width="50%"><img src="docs/screenshots/14-urltools-redirect.png" alt="Redirect chain checker with a real result"><br><sub>Redirect checker</sub></td>
</tr>
<tr>
<td colspan="2"><img src="docs/screenshots/15-urltools-qr.png" alt="QR code generated for a real link"><br><sub>QR code generator — a real QR for one of the links created above</sub></td>
</tr>
</table>
...
<table>
<tr>
<td width="50%"><img src="docs/screenshots/17-platform-api-list.png" alt="API keys page with a created key"><br><sub>Tiered API keys</sub></td>
<td width="50%"><img src="docs/screenshots/18-webhooks-list.png" alt="Webhooks page with a created webhook"><br><sub>Webhooks — HMAC-signed, event-subscribed</sub></td>
</tr>
<tr>
<td width="50%"><img src="docs/screenshots/19-notifications.png" alt="Notifications page with real first-visit notifications"><br><sub>Notifications — real "first visit" events</sub></td>
<td width="50%"><img src="docs/screenshots/20-devices-pairing.png" alt="Device pairing dialog with a live QR code and code"><br><sub>Devices — pairing a phone (QR + code, time-limited)</sub></td>
</tr>
<tr>
<td colspan="2"><img src="docs/screenshots/21-settings.png" alt="Settings page"><br><sub>Settings</sub></td>
</tr>
</table>

> The Devices screen shows the pairing step — generating the QR code / short code the companion Android app scans to connect. Completing the live handshake and mirroring a phone's screen needs a physical Android device paired at capture time, so it isn't shown here; the wire protocol is documented in full in [`docs/DEVICE_CONTROL_PROTOCOL.md`](./docs/DEVICE_CONTROL_PROTOCOL.md).
